				...
				<Navbar.Collapse id="basic-navbar-nav">
					<Nav className="ml-auto mr-auto navbar-color">
						...
						<NavDropdown className="mr-3" title="Caterigories" id="basic-nav-dropdown">
							<NavDropdown.Item className ="dark-color" href="#action/3.1">Action</NavDropdown.Item>
							<NavDropdown.Item className ="dark-color" href="#action/3.2">Another action</NavDropdown.Item>
							<NavDropdown.Item className ="dark-color" href="#action/3.3">Something</NavDropdown.Item>
							<NavDropdown.Divider />
							<NavDropdown.Item className ="dark-color" href="#action/3.4">Separated link</NavDropdown.Item>
						</NavDropdown>
